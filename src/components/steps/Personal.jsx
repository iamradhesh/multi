    ...
    handlegradDate('gradDate', newStartDate);
      ...
      return (
          ...
          <form onSubmit={handleSubmit} className='bg-white shadow-md rounded px-20 pt-6 pb-8 mb-4 justify-center items-center'>
            <div className="mb-4">
              <label htmlFor="firstName" className=" text-gray-700 text-sm font-bold mb-2"> Name:</label>
                            <input
                className="ml-4 shadow appearance-none border rounded w-1/2 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                type="text"
                id="firstName"
                name="firstName"
            ...
            <div className='md:flex md:items-center mb-6'>
              <label htmlFor="email" className='block text-gray-500 font-bold md:text-right mb-1 md:mb-0 pr-4'>Email:</label>
              <input
            ...
            <div className=' md:items-center mb-6' >
              <label className="text-gray-500 font-semibold md:text-right mb-1 md:mb-0 pr-4"  htmlFor="Major"> Major:</label>
              <input
              className='bg-gray-200 appearance-none border-2 border-gray-200 rounded w-1/2 py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500'
                type="text"
                id="Major"
            ...
            <label className="text-gray-500 font-semibold md:text-right mb-1 md:mb-0 pr-4" htmlFor='GradDate'>Graduation Date:</label>
